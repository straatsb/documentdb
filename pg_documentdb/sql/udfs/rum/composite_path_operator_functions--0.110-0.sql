...
CREATE OR REPLACE FUNCTION __API_SCHEMA_INTERNAL_V2__.gin_bson_composite_rum_config(internal)
 RETURNS void
 LANGUAGE c
 IMMUTABLE PARALLEL SAFE STRICT
AS 'MODULE_PATHNAME', $function$gin_bson_composite_rum_config$function$;