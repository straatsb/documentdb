...
/* update procedure */
CREATE OR REPLACE PROCEDURE __API_SCHEMA_V2__.update_txn_proc(
    p_database_name text,
    p_update __CORE_SCHEMA_V2__.bson,
    p_insert_documents __CORE_SCHEMA_V2__.bsonsequence DEFAULT NULL,
    p_transaction_id text DEFAULT NULL,
    ...
    p_success INOUT boolean DEFAULT NULL)
 LANGUAGE C
AS 'MODULE_PATHNAME', $$command_update_txn_proc$$;
COMMENT ON PROCEDURE __API_SCHEMA_V2__.update_txn_proc(text,__CORE_SCHEMA_V2__.bson,__CORE_SCHEMA_V2__.bsonsequence,text,__CORE_SCHEMA_V2__.bson,boolean)
    IS 'updates documents in a collection using a stored procedure, can be run inside a transaction';
...
/*
 * documentdb_api_v2.update processes a documentdb update wire-protocol command.
 */
CREATE OR REPLACE FUNCTION documentdb_api_v2.update(
    p_database_name text,
    p_update __CORE_SCHEMA_V2__.bson,
    p_insert_documents __CORE_SCHEMA_V2__.bsonsequence default NULL,
    p_transaction_id text default NULL,
 ...
 VOLATILE
AS 'MODULE_PATHNAME', $$command_update$$;
COMMENT ON FUNCTION documentdb_api_v2.update(text,__CORE_SCHEMA_V2__.bson,__CORE_SCHEMA_V2__.bsonsequence,text)
    IS 'update documents in a collection';

CREATE OR REPLACE PROCEDURE documentdb_api_v2.update_bulk(
    p_database_name text,
    p_update __CORE_SCHEMA_V2__.bson,
    p_insert_documents __CORE_SCHEMA_V2__.bsonsequence DEFAULT NULL,
    p_transaction_id text DEFAULT NULL,
 ...
 LANGUAGE C
AS 'MODULE_PATHNAME', $$command_update_bulk$$;
COMMENT ON PROCEDURE documentdb_api_v2.update_bulk(text,__CORE_SCHEMA_V2__.bson,__CORE_SCHEMA_V2__.bsonsequence,text,__CORE_SCHEMA_V2__.bson,boolean)
    IS 'update documents in a collection in a non-transactional manner';

/* Command: update */
CREATE OR REPLACE FUNCTION documentdb_api_internal_readwrite.update_one(
    p_collection_id bigint,
    p_shard_key_value bigint,
    p_query __CORE_SCHEMA_V2__.bson,
    p_update __CORE_SCHEMA_V2__.bson,
 ...
 LANGUAGE C
AS 'MODULE_PATHNAME', $$command_update_one$$;
COMMENT ON FUNCTION documentdb_api_internal_readwrite.update_one(bigint,bigint,__CORE_SCHEMA_V2__.bson,__CORE_SCHEMA_V2__.bson,__CORE_SCHEMA_V2__.bson,bool,__CORE_SCHEMA_V2__.bson,bool,__CORE_SCHEMA_V2__.bson,__CORE_SCHEMA_V2__.bson,text)
    IS 'updates a single document in a collection';


/* Command: update_worker */
CREATE OR REPLACE FUNCTION documentdb_api_internal_readwrite.update_worker(
    p_collection_id bigint,
    p_shard_key_value bigint,
    p_shard_oid regclass,
    p_update_internal_spec __CORE_SCHEMA_V2__.bson,
